...
path_to_project = os.path.abspath(os.path.join(path_to_project, os.pardir, os.pardir))
...
def preprocess_NoXi(device, extract_faces=True, extract_poses=True):
    ...
    if extract_poses:
        pose_detector = SimpleHRNet(c=48, nof_joints=17, multiperson=True,
                               yolo_version = 'v3',
                               yolo_model_def=os.path.join(path_to_project,"models_/detectors/yolo/config/yolov3.cfg"),
                               yolo_class_path=os.path.join(path_to_project,"models_/detectors/yolo/data/coco.names"),
                               yolo_weights_path=os.path.join(path_to_project,"models_/detectors/yolo/weights/yolov3.weights"),
                               checkpoint_path=os.path.join(path_to_project, "pose_hrnet_w48_384x288.pth"),
