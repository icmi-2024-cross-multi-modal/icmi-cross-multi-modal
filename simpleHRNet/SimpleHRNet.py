"""
The code is taken from the "unofficial implementation of the paper Deep High-Resolution Representation Learning for Human Pose Estimation.":
Please, cite the paper if you use this model: https://arxiv.org/abs/1902.09212
As well as the authors of the code: https://github.com/stefanopini/simple-HRNet
"""
...
class SimpleHRNet:
    ...
    def __init__(self,
        ...
        if not self.enable_tensorrt:
            ...
            raise ValueError("tensorrt is not supported")
